...
class UsersRecord extends FirestoreRecord {
  ...
  // "datadeaniversario" field.
  DateTime? _datadeaniversario;
  DateTime? get datadeaniversario => _datadeaniversario;
  bool hasDatadeaniversario() => _datadeaniversario != null;
  ...
  void _initializeFields() {
    ...
    _datadeaniversario = snapshotData['datadeaniversario'] as DateTime?;
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        e1?.datadeaniversario == e2?.datadeaniversario &&
